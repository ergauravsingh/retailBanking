...
<body>
	...
	<div align="center">
				<caption style="font-family: Bradley Hand ITC;">
					<br><h3 style="color:black;">Retail Bank</h3>
				</caption>
			</div>
	<div class="d-flex justify-content-center">
				...
				<caption style="font-family: Bradley Hand ITC;">
					...
					<table class="center table table-success table-striped" border="2" cellpadding="7" style="width: 900;">
						<tr >
							<th>CUSTOMER ID</th>
							<th>CUSTOMER NAME</th>
							<th>DOB</th>
					...
					<table class="table table-success table-striped" border="2" cellpadding="5" style="width: 900;">
						<tr>
							<th>ACCOUNT ID</th>
