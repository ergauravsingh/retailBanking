...
<body class="doodle">
	...
	<!--------------------- Navigation------------------>
		...
		<li><div class="navbar-brand">&nbsp;&nbsp;Retail Bank</div></li>
		<li style="float:right"><a class="active"  href="/logout">Logout</a></li>
		</ul>

			
		<center>
			<br><h1 style="font-weight: 400; color:black;">Welcome to Retail Bank</h1>
		</center>
		
		<div class="row justify-content-center">		
			<div>
				<div class="card   " style="width: 950px; background: rgb(0, 0, 0); /* Fallback color */
  					background: rgba(0, 0, 0, 0.89); /* Black background with 0.5 opacity */
  					color: #f1f1f1;">
					<div class="card-body">
						<div align="center">
				<caption style="font-family: Bradley Hand ITC;">
					...
					<table class="center table table-danger table-striped" border="2" cellpadding="5" class="center" style="width: 900;">
						<tr >
							<th>CUSTOMER ID</th>
							<th>CUSTOMER NAME</th>
							<th>DOB</th>
	...
	<div class="row mt-5">
			...
			<div class="card   " style="width: fit-content; min-width:100%;  background: rgb(0, 0, 0); /* Fallback color */
				background: rgba(0, 0, 0, 0.89); /* Black background with 0.5 opacity */
				color: #f1f1f1;">
				<div class="card-body">
					<div align="center">
					...
					<br><br>
					<form action="/customerdashboard/showtransactions" method="post">
				...
				<c:if test="${!empty transactions}">
					<table class="center table table-success table-striped" border="1" cellpadding="5">
