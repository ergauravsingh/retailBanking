...
<body>
	...
	<div class="container">
		<div class="card login-card"
			style="background: rgb(0, 0, 0); /* Fallback color */ background:  rgb(0 0 0 / 82%);">
			<div class="row no-gutters">
				<div class="col-md-6">
					<div class="card-body">
						<div class="brand-wrapper" align="center">
							<h1 class="header " style="color: aliceblue;">Retail Bank</h1>
						</div>
						<br><h4 class="login-card-description" style="color: aliceblue;">${role} - Log
							In</h4>
						...
						<form:form action="/login" method="post" modelAttribute="login">
							<div class="form-group">
								...
								<form:input type="text" path="userid" name="Id" id="Id"
									class="form-control" placeholder="UserId" autocomplete="off" required="required"/>
							</div>
