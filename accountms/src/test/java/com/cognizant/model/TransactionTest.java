...
class TransactionTest {
	...
	Transaction transaction2 = new Transaction(1l, 1l, "AB", 3l, "CD", 1000, null, "deposit");
	...
	void sourceOwnerNameTest() {
		transaction.setSourceOwnerName("CD");
		assertEquals("CD", transaction.getSourceOwnerName());
	}

	@Test
	void setTargetOwnerNameTest() {
		transaction.setTargetOwnerName("AB");
		assertEquals("AB", transaction.getTargetOwnerName());
	}
