...
public class ControllerAdvice 
{
	...
	@ResponseStatus(HttpStatus.NOT_FOUND)
	public ErrorMessage appuserNotFoundException(AppUserNotFoundException appuserNotFoundException) 
	{
		return new ErrorMessage(HttpStatus.NOT_FOUND,LocalDateTime.now(),appuserNotFoundException.getMessage());
	}
